...
function Ronaldo(props) {
    ...
    const [ronaldoNews,updatenews]= useState([
        {
            key:1,
            Topic: "Everything ronaldo",
            image: {uri:"https://e0.365dm.com/22/05/768x432/skysports-cristiano-ronaldo_5758794.jpg?20220502232036"},
            ...
            image: {uri:"https://library.sportingnews.com/styles/twitter_card_120x120/s3/2022-03/messi-ronaldo.jpeg?itok=aVPZSCs8"}
        },{
            key:3,
    ...
    return (
        <View style={{height:fullpercent}}>
            {/* list of all item  */}
            <FlatList data={ronaldoNews} showsVerticalScrollIndicator={false} renderItem={({item})=>{
                return (
                    // the button 
