...
function Score(props) {
    ...
    const [liveScore,updatenews]= useState([
        {
            key:1,
            Topic: "Man u 0 - lincoln 1",
    ...
    return (
        <View style={{height:fullpercent}}>
            {/* list of all item  */}
            <FlatList data={liveScore} showsVerticalScrollIndicator={false} renderItem={({item})=>{
                return (
                    // the button 
